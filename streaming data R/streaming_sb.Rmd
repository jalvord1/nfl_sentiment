...
#first half
filename <- "/Users/juliannaalvord/Documents/nfl sentiment/sb_tweets_half1.json"

#parse those tweets from above
rt <- parse_stream(filename)

#second half
filename <- "/Users/juliannaalvord/Documents/nfl sentiment/sb_tweets_half2.json"

#parse tweets from above
rt2 <- parse_stream(filename)
```

#writing out/daving files
```{r}
...
#adding more saves for new loaded files
save(rt, file = "/Users/juliannaalvord/Documents/nfl sentiment/sb_tweets_half1.rda")

save(rt2, file = "/Users/juliannaalvord/Documents/nfl sentiment/sb_tweets_half2.rda")
